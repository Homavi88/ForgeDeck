...
4. Документы **обязательны в том же PR**, что и код. Правило для агентов: [`.cursor/rules/docs-sync.mdc`](.cursor/rules/docs-sync.mdc). Минимум: `CHANGELOG.md` (Unreleased) + нужный файл в `docs/`. Публичный `README.md` — лендинг продукта; подробности — в [`docs/`](docs/).
